  ...
  return (
    <footer className="bg-black text-white px-6 md:px-24 py-16 w-full">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div>
            ...
            <p className="text-base md:text-lg text-gray-300 leading-relaxed">
              ...
              Siruseri, Tamil Nadu 603103 <br />
              <br />
              <b>3. Krishnagiri (Campus)</b>
              <br />
      ...
      <div className="flex flex-col md:flex-row justify-between items-center py-6 text-sm md:text-lg">
        ...
        {/* Right Links (Home, Programs, College) */}
        <div className="flex flex-col md:flex-row md:space-x-10 mt-4 md:mt-0 items-start md:items-end w-full md:w-auto md:justify-end text-left">
          <a href="/" className="hover:underline text-lg md:text-xl">
            Home
          </a>
          <a href="/mern-fullstack" className="hover:underline text-lg md:text-xl mt-2 md:mt-0">
            Programs
          </a>
          <a href="/college-onboarding" className="hover:underline text-lg md:text-xl mt-2 md:mt-0">
            College
          </a>
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-8 py-10 border-b border-gray-700">
        ...
        {/* Quick Menu */}
        <div className="flex flex-col space-y-4 text-lg md:text-xl">
          <h3 className="font-bold text-xl mb-2">Quick Menu</h3>
          <br />
