    ...
    <section className=" px-6 md:px-24 py-16 flex justify-center">
      <div className="max-w-[1280px] w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
          {/* Left Image */}
          <div>
            <img src={banner1} alt="AI Full Stack Course" className="w-full h-full object-cover rounded-lg" />
          </div>
          ...
          <div className="bg-white shadow-xl rounded-lg p-6 space-y-6 h-full flex flex-col justify-between border border-gray-200">
            <div className="flex items-center gap-3">
              ...
              <p className="text-gray-700 text-sm">
                Course <span className="font-medium ml-4">AI Full Stack Development</span>
              </p>
            </div>
            <div className="flex items-center gap-3">
              <Clock size={18} className="text-gray-700" />
              <p className="text-gray-700 text-sm">
                Duration <span className="font-medium ml-4">9 Months</span>
              </p>
            </div>
            <div className="flex items-center gap-3">
        ...
        {activeTab === "Tools & Software's" && (
          <div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-6">
              ...
              <div className="flex flex-col items-center">
                <img src="https://placehold.co/48x48/61DAFB/fff?text=Python" alt="Python" className="w-12 h-12" />
                <p className="text-sm mt-2">Python</p>
              </div>
              <div className="flex flex-col items-center">
                <img src="https://placehold.co/48x48/F3F1F1/000?text=Tensor" alt="TensorFlow" className="w-12 h-12" />
                <p className="text-sm mt-2">TensorFlow</p>
              </div>
              <div className="flex flex-col items-center">
                <img src="https://placehold.co/48x48/F37726/fff?text=Jupyter" alt="Jupyter" className="w-12 h-12" />
                <p className="text-sm mt-2">Jupyter</p>
              </div>
              <div className="flex flex-col items-center">
        ...
        {activeTab === "Projects" && (
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            <div className="w-full h-48 bg-gray-200 rounded-lg flex items-center justify-center text-center text-gray-500">AI-powered Recommendation Engine</div>
            <div className="w-full h-48 bg-gray-200 rounded-lg flex items-center justify-center text-center text-gray-500">Sentiment Analysis Tool</div>
            <div className="w-full h-48 bg-gray-200 rounded-lg flex items-center justify-center text-center text-gray-500">Chatbot with NLP</div>
            <div className="w-full h-48 bg-gray-200 rounded-lg flex items-center justify-center text-center text-gray-500">Image Recognition App</div>
          </div>
        )}
      </div>
    </section>
