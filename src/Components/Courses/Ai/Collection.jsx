...
{
icon: U1,
title: "Expert AI Full Stack Development Senior Mentors",
desc: "Expert AI Full Stack mentors at your service. They deliver outstanding answers with clarity and depth. Because your growth deserves the best guidance Our mentors deliver answers that matter."
},
{
icon: U2,
      ...
      <div className="max-w-[1280px] w-full">
        ...
        <div className="flex flex-col md:flex-row md:justify-center md:divide-x divide-gray-300 text-center mb-14">
          <div className="px-6 py-2">
            <h3 className="text-lg font-medium">AI Full Stack Development</h3>
