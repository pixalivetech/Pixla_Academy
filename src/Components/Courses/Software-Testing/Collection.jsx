...
const features = [
  {
    icon: U1,
    title: "Expert Software Testing Senior Mentors",
  ...
  },
  {
    ...
    desc: "Learn by doing—solve real problems, present real solutions. Work on real-world challenges that build your portfolio and confidence."
  },
];
      ...
      <div className="max-w-[1280px] w-full">
        ...
        <div className="flex flex-col md:flex-row md:justify-center md:divide-x divide-gray-300 text-center mb-14">
          <div className="px-6 py-2">
            <h3 className="text-lg font-medium">Software Testing</h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {features.map((item, idx) => (
            <div
              key={idx}
              className="flex flex-col items-center text-center px-6 py-8  bg-white  transition-shadow"
            >
              <img
                src={item.icon}
                alt={item.title}
