...
import Hero1 from "./../../../assets/Courses/Mern/hero section.png";
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 text-center px-6">
        <h1 className="text-white mt-20 text-3xl md:text-5xl font-semibold mb-6">
          MERN/ MEAN Full Stack Development
        </h1>

        <p className="text-white text-lg md:text-2xl font-medium mb-6">
          Master the Craft of MERN/ MEAN Full Stack Development with Our Academy. <br className="hidden md:block" /> 
         Development with Our Academy.
        </p>
