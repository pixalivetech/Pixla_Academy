...
// Using placeholder images since local assets cannot be resolved
const features = [
{
// Represents the first icon from the provided image
icon: U1,
title: "Expert Python Full Stack Development Senior Mentors",
...
{
// Represents the second icon from the provided image
icon: U2,
...
{
// Represents the third icon from the provided image
icon: U3,
      ...
      <div className="max-w-[1280px] w-full">
        ...
        <div className="flex flex-col md:flex-row md:justify-center md:divide-x divide-gray-300 text-center mb-14">
          <div className="px-6 py-2">
            <h3 className="text-lg font-medium">Python Full Stack Development</h3>
